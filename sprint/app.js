...
function renderMetrics() {
  ...
  $('#budget-status').textContent = `${money(spent)} recorded in this browser · $40 Cloud Forest · $40 Lyceum · $40 DojoZeus approved caps · $0 unallocated. Spend, delivery, impressions, and conversions remain unverified.`;
